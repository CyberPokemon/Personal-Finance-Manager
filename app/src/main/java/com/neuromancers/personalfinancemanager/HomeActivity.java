...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab = findViewById(R.id.fab_add_transaction);
...
// Load transactions from DB
        transactionList = dbHelper.getTransactionsForUser(currentUserId);
        Collections.reverse(transactionList); // optional: show latest first
    ...
    private void showAddTransactionDialog() {
        ...
        btnSubmit.setOnClickListener(v -> {
            ...
            dbHelper.insertTransaction(currentUserId, amount, type, datetime, description, person, account);

            updateChart(); // refresh pie chart
            dialog.dismiss();
            // Reload transactions and update UI
            transactionList.clear();
            transactionList.addAll(dbHelper.getTransactionsForUser(currentUserId));
            Collections.reverse(transactionList); // to keep newest on top
