...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public void insertRecord(double amt, String category, String otherAcNo, String type) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put("amt", amt);
        values.put("category", category);
        if (otherAcNo == null || otherAcNo.trim().isEmpty()) {
            values.putNull("otherAcNo");
        } else {
            values.put("otherAcNo", otherAcNo);
        }
